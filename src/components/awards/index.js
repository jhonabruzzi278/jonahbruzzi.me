...
const award_data = [
  {
    id: "one",
    topic: "ENVÍO GRATIS",
    title: "Premio a pintura moderna",
    data_src: award_img_1,
    subtitle: "Finalista - “ Decoración de la semana “",
    delay: ".3s",
  },
  {
    id: "two",
    topic: "DEVOLUCIÓN GRATIS",
    title: "Elección del público: mejor diseño",
          ...
          <div className="row">
            <div className="col-xxl-12">
              <div className={`section__title-wrapper-9 mb-55 text-center`}>
                <h3 className="section__title-9">Nuestros premios.</h3>
              </div>
            </div>
          </div>
          <div className="row">

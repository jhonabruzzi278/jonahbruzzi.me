...
const ForgotPasswordArea = ({ token, email }) => {
  ...
  const onSubmit = (data) => {
    confirmForgotPassword({
      ...
      if(result?.error){
        notifyError(result?.error?.data?.message || "No se pudo restablecer la contraseña")
      }
      else {
            ...
            <div className="col-xl-6 col-lg-8 col-md-10">
              <div className="login__wrapper">
                <div className="login__top mb-30 text-center">
                  <h3 className="login__title">Restablecer contraseña</h3>
